...
equiv (Call a b _) (Call a' b' _) = a `equivIdent` a' && b `equivExprs` b'
equiv (Uncall a b _) (Uncall a' b' _) = a `equivIdent` a' && b `equivExprs` b'
equiv (ExtCall a b _) (ExtCall a' b' _) = a `equivIdent` a' && b `equivExprs` b'
equiv (ExtUncall a b _) (ExtUncall a' b' _) = a `equivIdent` a' && b `equivExprs` b'
